armor:register_armor("tlib_armor:helmet_starter", {
	...
	groups = {armor_head=1, armor_heal=12, armor_use=0, armor_water=1,},
...
armor:register_armor("tlib_armor:chestplate_starter", {
	...
	armor_groups = {fleshy=10},
	groups = {armor_torso=1, armor_heal=12, armor_use=0, armor_water=1,},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
...
armor:register_armor("tlib_armor:leggings_starter", {
	...
	armor_groups = {fleshy=10},
	groups = {armor_legs=1, armor_heal=12, armor_use=0, armor_water=1,},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
...
armor:register_armor("tlib_armor:boots_starter", {
	...
	armor_groups = {fleshy=10},
	groups = {armor_feet=1, armor_heal=12, armor_use=0, physics_speed=0.2, armor_water=1,},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
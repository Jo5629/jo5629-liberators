...
local max_gun_efficiency = tonumber(minetest.settings:get("tlib_rangedweapons_max_gun_efficiency")) or 300
...
if minetest.settings:get_bool("tlib_rangedweapons_infinite_ammo", false) then
...
if minetest.settings:get_bool("tlib_rangedweapons_gun_wear", true) then
...
----------------------------------
	...
	if has_shell > 0 and minetest.settings:get_bool("tlib_rangedweapons_animate_empty_shells", true) then
...
if minetest.settings:get_bool("tlib_rangedweapons_shurikens", true) then
	dofile(modpath.."/shurikens.lua")
end

if minetest.settings:get_bool("tlib_rangedweapons_handguns", true) then
...
if minetest.settings:get_bool("tlib_rangedweapon_forceguns", true) then
	dofile(modpath.."/forcegun.lua")
end

if minetest.settings:get_bool("tlib_rangedweapons_javelins", true) then
	dofile(modpath.."/javelin.lua")
end

if minetest.settings:get_bool("tlib_rangedweapons_power_weapons", true) then
...
if minetest.settings:get_bool("tlib_rangedweapons_machine_pistols", true) then
	dofile(modpath.."/tmp.lua")
	dofile(modpath.."/tec9.lua")
	dofile(modpath.."/uzi.lua")
	dofile(modpath.."/kriss_sv.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_shotguns", true) then
	dofile(modpath.."/remington.lua")
	dofile(modpath.."/spas12.lua")
	dofile(modpath.."/benelli.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_auto_shotguns", true) then
	dofile(modpath.."/jackhammer.lua")
	dofile(modpath.."/aa12.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_smgs", true) then
	dofile(modpath.."/mp5.lua")
	dofile(modpath.."/ump.lua")
	dofile(modpath.."/mp40.lua")
	dofile(modpath.."/thompson.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_rifles", true) then
	dofile(modpath.."/awp.lua")
	dofile(modpath.."/svd.lua")
	dofile(modpath.."/m200.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_heavy_machineguns", true) then
	dofile(modpath.."/m60.lua")
	dofile(modpath.."/rpk.lua")
	dofile(modpath.."/minigun.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_revolvers", true) then
	dofile(modpath.."/python.lua")
	dofile(modpath.."/taurus.lua")
end
if minetest.settings:get_bool("tlib_rangedweapons_assault_rifles", true) then
...
if minetest.settings:get_bool("tlib_rangedweapons_explosives", true) then
...
if minetest.settings:get_bool("tlib_rangedweapons_glass_breaking", true) then

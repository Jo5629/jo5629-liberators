...
local use_particles = minetest.settings:get_bool("tlib_rangedweapons_impact_particles", true)
...
if door_break > 0 and minetest.settings:get_bool("tlib_rangedweapons_door_breaking", true) then
...
if glass_break > 0 and minetest.settings:get_bool("tlib_rangedweapons_glass_breaking", true) then
...
if minetest.get_item_group(minetest.get_node(moveresult.collisions[1].node_pos).name, "level") > 1  then
   if minetest.settings:get_bool("tlib_rangedweapons_bullet_ricochet", true) then
...
local player_dmg_multiplier = tonumber(minetest.settings:get("tlib_rangedweapons_player_dmg_multiplier")) or 1.0
local headshot_dmg_multiplier = tonumber(minetest.settings:get("tlib_rangedweapons_headshot_dmg_multiplier")) or 1.75
local mob_dmg_multiplier = tonumber(minetest.settings:get("tlib_rangedweapons_mob_dmg_multiplier")) or 1.0
...
owner:hud_change(hit, "text", hit_texture)
	...
	local bloodyness = tonumber(minetest.settings:get("tlib_rangedweapons_bloodyness")) or 10

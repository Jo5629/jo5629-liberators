----------------------------
----------------------------
if minetest.settings:get_bool("tlib_rangedweapons_gun_crafting", true) then
...
----------------------------------
----------------------------------
if minetest.settings:get_bool("tlib_rangedweapons_other_weapons_crafting", true) then
...
------------------------------------
------------------------------------
if minetest.settings:get_bool("tlib_rangedweapons_ammo_crafting", true) then
...
-------------------------------------
-------------------------------------
if minetest.settings:get_bool("tlib_rangedweapons_item_crafting", true) then
